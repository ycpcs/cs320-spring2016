...
Make sure that **SSH** is displayed for the clone credentials (just to the right of "Find file" button). Click the **Fork** button (upper right button labelled "fork" under the Profile icon).  This will make a clone of this repository in your own GitHub account.  This will be your personal public repository for this lab.
